...
[ptext layer="fix" text="ON" x="60" y="370" size="20" color="black" bold="bold" edge="white" cond="f.scn_skip == 1"]
[ptext layer="fix" text="OFF" x="60" y="370" size="20" color="black" bold="bold" edge="white" cond="f.scn_skip == 0"]
