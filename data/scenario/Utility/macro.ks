...
[macro name="openDetailDescription"]
    ...
    [if exp="tf.isCharacter == 1"]
        ...
        [ptext layer="1" text="血液型：" x="1350" y="580" size="25" name="bloodtype_header"]
        [ptext layer="1" text="%bloodtype" x="1460" y="580" size="25" name="bloodtype"]
        [ptext layer="1" text="誕生日：" x="1350" y="630" size="25" name="birthday_header"]
        [ptext layer="1" text="%birthday" x="1460" y="630" size="25" name="birthday"]
        [ptext layer="1" text="身長：" x="1350" y="680" size="25" name="stature_header"]
        [ptext layer="1" text="%stature" x="1430" y="680" size="25" name="stature"]
        [ptext layer="1" text="出身地：" x="1350" y="730" size="25" name="birthplace_header"]
        [ptext layer="1" text="%birthplace" x="1460" y="730" size="25" name="birthplace"]
        [ptext layer="1" text="趣味：" x="1350" y="780" size="25" name="hobby_header"]
        [ptext layer="1" text="%hobby" x="1430" y="780" size="25" name="hobby"]
        [ptext layer="1" text="特技：" x="1350" y="830" size="25" name="specialskill_header"]
        [ptext layer="1" text="%specialskill" x="1430" y="830" size="25" name="specialskill"]
        [ptext layer="1" text="モチーフ：" x="1350" y="880" size="25" name="motif_header"]
        [ptext layer="1" text="%motif" x="1480" y="880" size="25" name="motif"]
        [ptext layer="1" text="%description" x="1350" y="930" size="25" name="description"]
    [else]
        [image storage="%storage" layer="1" x="920" y="430" width="300" height="300" name="picture"]
        [ptext layer="1" text="%furigana" x="%x" y="370" size="25" name="furigana"]
        [ptext layer="1" text="%name" x="1350" y="400" size="50" name="name"]
