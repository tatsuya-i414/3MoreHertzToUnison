...
[macro name="ItemImage"]
    ...
    [if exp="f.isHungerGet == 1"]
        [eval exp="tf.usingItemInventory2 = 1"]
        [image storage="../image/episode2/hunger.png" layer="2" x="1770" y="100" width="70" height="70" visible="true" name="hunger"]
    [endif]
    ...
    [if exp="f.isBlueBlockGet == 1"]
        ...
        [image storage="../image/episode2/blueblock_item.png" layer="2" x="1770" y="250" width="70" height="70" visible="true" name="blueblock"]
    [endif]
    [if exp="f.isRedBlockGet == 1"]
        [eval exp="tf.usingItemInventory5 = 1"]
        [image storage="../image/episode2/redblock_item.png" layer="2" x="1770" y="325" width="70" height="70" visible="true" name="redblock"]
    [endif]
    [if exp="f.isGreenBlockGet == 1"]
        [eval exp="tf.usingItemInventory6 = 1"]
        [image storage="../image/episode2/greenblock_item.png" layer="2" x="1770" y="400" width="70" height="70" visible="true" name="greenblock"]
    [endif]
    ...
    [if exp="f.isCurtainGet == 1"]
        [eval exp="tf.usingItemInventory5 = 1"]
        [image storage="../image/episode2/curtain.png" layer="2" x="1770" y="325" width="70" height="70" visible="true" name="curtain"]
    [endif]
