...
[macro name="ItemInventory"]
    ...
    ; インベントリ画像
    [image storage="../image/share/inventory.png" layer="1" x="1770" y="150" name="inventory1"]
    [image storage="../image/share/inventory.png" layer="1" x="1770" y="225" name="inventory2"]
    [image storage="../image/share/inventory.png" layer="1" x="1770" y="300" name="inventory3"]
    [image storage="../image/share/inventory.png" layer="1" x="1770" y="375" name="inventory4"]
    [image storage="../image/share/inventory.png" layer="1" x="1770" y="450" name="inventory5"]
    [image storage="../image/share/inventory.png" layer="1" x="1770" y="525" name="inventory6"]
    [image storage="../image/share/inventory.png" layer="1" x="1770" y="600" name="inventory7"]
[endmacro]
...
[macro name="ItemImage"]
    ...
    [if exp="f.isCableGet == 1"]
        ...
        [image storage="../image/episode1/cable.png" layer="2" x="1770" y="225" width="70" height="70" visible="true" name="cable"]
    [endif]
    [if exp="f.isDriverGet == 1"]
        [eval exp="tf.usingItemInventory1 = 1"]
        [image storage="../image/episode1/driver_item.png" layer="2" x="1770" y="150" width="70" height="70" visible="true" name="driver"]
    [endif]
    [if exp="f.isLightCoverGet == 1"]
        [eval exp="tf.usingItemInventory3 = 1"]
        [image storage="../image/episode1/lightcover_item.png" layer="2" x="1770" y="300" width="70" height="70" visible="true" name="lightcover"]
    [endif]
    [if exp="f.isHungerGet == 1"]
        [eval exp="tf.usingItemInventory2 = 1"]
        [image storage="../image/episode2/hunger.png" layer="2" x="1770" y="125" width="170" height="70" visible="true" name="hunger"]
    [endif]
    [if exp="f.isPencilGet == 1"]
        [eval exp="tf.usingItemInventory3 = 1"]
        [image storage="../image/episode2/pencil.png" layer="2" x="1770" y="300" visible="true" name="pencil"]
    [endif]
    [if exp="f.isBlueBlockGet == 1"]
        [eval exp="tf.usingItemInventory4 = 1"]
        [image storage="../image/episode2/blueblock_item.png" layer="2" x="1770" y="375" width="70" height="70" visible="true" name="blueblock"]
    [endif]
    [if exp="f.isRedBlockGet == 1"]
        [eval exp="tf.usingItemInventory5 = 1"]
        [image storage="../image/episode2/redblock_item.png" layer="2" x="1770" y="450" width="70" height="70" visible="true" name="redblock"]
    [endif]
    [if exp="f.isGreenBlockGet == 1"]
        [eval exp="tf.usingItemInventory6 = 1"]
        [image storage="../image/episode2/greenblock_item.png" layer="2" x="1770" y="525" width="70" height="70" visible="true" name="greenblock"]
    [endif]
    [if exp="f.isDressGet == 1"]
        [eval exp="tf.usingItemInventory4 = 1"]
        [image storage="../image/episode2/dress.png" layer="2" x="1770" y="375" visible="true" name="dress"]
    [endif]
    [if exp="f.isCurtainGet == 1"]
        [eval exp="tf.usingItemInventory5 = 1"]
        [image storage="../image/episode2/curtain.png" layer="2" x="1770" y="450" width="70" height="70" visible="true" name="curtain"]
    [endif]
    ...
    [if exp="f.isFutonGet == 1"]
        [eval exp="tf.usingItemInventory4 = 1"]
        [image storage="../image/episode3/futon.png" layer="2" x="1770" y="375" visible="true" name="futon"]
    [endif]
[endmacro]
...
[macro name="SelectItemClickable"]
    [if exp="tf.usingItemInventory1 == 1"]
        [clickable x="1770" y="150" width="70" height="70" target="%target_1" opacity="30" mouseopacity="50" color="0x505050"]
    [endif]
    [if exp="tf.usingItemInventory2 == 1"]
        [clickable x="1770" y="225" width="70" height="70" target="%target_2" opacity="30" mouseopacity="50" color="0x505050"]
    [endif]
    [if exp="tf.usingItemInventory3 == 1"]
        [clickable x="1770" y="300" width="70" height="70" target="%target_3" opacity="30" mouseopacity="50" color="0x505050"]
    [endif]
    [if exp="tf.usingItemInventory4 == 1"]
        [clickable x="1770" y="375" width="70" height="70" target="%target_4" opacity="30" mouseopacity="50" color="0x505050"]
    [endif]
    [if exp="tf.usingItemInventory5 == 1"]
        [clickable x="1770" y="450" width="70" height="70" target="%target_5" opacity="30" mouseopacity="50" color="0x505050"]
    [endif]
    [if exp="tf.usingItemInventory6 == 1"]
        [clickable x="1770" y="525" width="70" height="70" target="%target_6" opacity="30" mouseopacity="50" color="0x505050"]
    [endif]
    [if exp="tf.usingItemInventory7 == 1"]
        [clickable x="1770" y="600" width="70" height="70" target="%target_7" opacity="30" mouseopacity="50" color="0x505050"]
    [endif]
[endmacro]
