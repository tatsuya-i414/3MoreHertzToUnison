...
[macro name="ItemImage"]
    ...
    [if exp="f.isBlueBlockGet == 1"]
        ...
        [image storage="../image/episode2/blueblock.png" layer="2" x="1770" y="250" width="70" height="70" visible="true" name="blueblock"]
    [endif]
    [if exp="f.isRedBlockGet == 1"]
        [eval exp="tf.usingItemInventory5 = 1"]
        [image storage="../image/episode2/redblock.png" layer="2" x="1770" y="325" width="70" height="70" visible="true" name="redblock"]
    [endif]
    [if exp="f.isGreenBlockGet == 1"]
        [eval exp="tf.usingItemInventory6 = 1"]
        [image storage="../image/episode2/greenblock.png" layer="2" x="1770" y="400" width="70" height="70" visible="true" name="greenblock"]
    [endif]
