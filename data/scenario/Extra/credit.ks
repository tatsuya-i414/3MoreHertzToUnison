...
[ptext layer="fix" text="脚本" x="&tf.staff[0]" y="440" size="&tf.characterSetting[0]" width="&tf.characterSetting[1]" align="right"]
...
[ptext layer="fix" text="On-Jin ～音人～" x="&tf.usedMaterial" y="500" size="&tf.characterSetting[0]" width="&tf.characterSetting[1]" align="left"]
[ptext layer="fix" text="OtoLogic" x="&tf.usedMaterial" y="560" size="&tf.characterSetting[0]" width="&tf.characterSetting[1]" align="left"]
...
[ptext layer="fix" text="ポケットサウンド" x="&tf.usedMaterial" y="680" size="&tf.characterSetting[0]" width="&tf.characterSetting[1]" align="left"]
[ptext layer="fix" text="効果音辞典" x="&tf.usedMaterial" y="740" size="&tf.characterSetting[0]" width="&tf.characterSetting[1]" align="left"]
[ptext layer="fix" text="効果音工房" x="&tf.usedMaterial" y="800" size="&tf.characterSetting[0]" width="&tf.characterSetting[1]" align="left"]
[s]
