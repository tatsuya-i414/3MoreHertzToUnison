...
[macro name="openDetailDescription"]
    ...
    [if exp="tf.isCharacter == 1"]
        [image storage="%storage" layer="1" x="%image_x|1010" y="%image_y|355" width="%width|234" height="%height|634" name="picture" time="10" wait="true"]
    ...
    [else]
        [image storage="%storage" layer="1" x="%image_x|950" y="%image_y|400" width="%width|300" height="%height|300" name="picture" time="10" wait="true"]
        [ptext layer="1" text="%furigana" x="%x" y="370" size="25" name="furigana"]
        [ptext layer="1" text="%name" x="1350" y="400" size="50" name="name"]
...
[macro name="deleteDetailDescription"]
    [free layer="1" name="picture" time="10" wait="true"]
    [free layer="1" name="furigana" time="10" wait="true"]
    [free layer="1" name="name" time="10" wait="true"]
    [free layer="1" name="age_header" time="10" wait="true"]
    [free layer="1" name="age" time="10" wait="true"]
    [free layer="1" name="bloodtype_header" time="10" wait="true"]
    [free layer="1" name="bloodtype" time="10" wait="true"]
    [free layer="1" name="birthday_header" time="10" wait="true"]
    [free layer="1" name="birthday" time="10" wait="true"]
    [free layer="1" name="stature_header" time="10" wait="true"]
    [free layer="1" name="stature" time="10" wait="true"]
    [free layer="1" name="birthplace_header" time="10" wait="true"]
    [free layer="1" name="birthplace" time="10" wait="true"]
    [free layer="1" name="hobby_header" time="10" wait="true"]
    [free layer="1" name="hobby" time="10" wait="true"]
    [free layer="1" name="specialskill_header" time="10" wait="true"]
    [free layer="1" name="specialskill" time="10" wait="true"]
    [free layer="1" name="motif_header" time="10" wait="true"]
    [free layer="1" name="motif" time="10" wait="true"]
    [free layer="1" name="description" time="10" wait="true"]
[endmacro]
