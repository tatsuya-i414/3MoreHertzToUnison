...
[if exp="f.mode == 'develop' || f.mode == 'kenshou' "]
    [glink color="bth06" text="会話パートをスキップ" x="1560" y="880" width="150" height="45" size="24" bold="true" exp="f.scn_skip = 1" cond="f.scn_skip == 0"]
    [glink color="bth06" text="会話パートをスキップ" x="1560" y="880" width="150" height="45" size="24" bold="true" exp="f.scn_skip = 0" cond="f.scn_skip == 1"]
