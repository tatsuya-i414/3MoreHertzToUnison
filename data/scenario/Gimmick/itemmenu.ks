...
[if exp="f.isBlueBlockGet== 1"]
    ...
    [image storage="../image/episode2/blueblock.png" layer="2" x="610" y="350" width="140" height="140" visible="true" name="blueblock"]
[endif]
[if exp="f.isRedBlockGet == 1"]
    [eval exp="tf.usingItemInventory5 = 1"]
    [image storage="../image/episode2/redblock.png" layer="2" x="760" y="350" width="140" height="140" visible="true" name="redblock"]
[endif]
[if exp="f.isGreenBlockGet == 1"]
    [eval exp="tf.usingItemInventory6 = 1"]
    [image storage="../image/episode2/greenblock.png" layer="2" x="910" y="350" width="140" height="140" visible="true" name="greenblock"]
[endif]
